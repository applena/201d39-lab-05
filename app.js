...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var fourth = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + totalProduct[0]+ '.';
 return [totalSum[0], totalProduct[0], third, fourth];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var summary = sumArr + ' was passed in as an array of numbers, and ' + totalSum + ' is their sum.';
  return [totalSum, summary];
 }
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var summary = 'The numbers ' + multArr + ' have a product of ' + totalProduct + '.';
  return [totalProduct, summary];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  var summary = 'The numbers ' + dynamicArray + ' have a product of ' + totalProduct + '.';
  return [totalProduct, summary];
}
